...
-- Step 2: Extract companies from existing contacts.company field 
INSERT INTO companies (name, domain, owner_id, created_at, updated_at)
WITH contact_company_extraction AS (
  SELECT DISTINCT 
    ...
    -- This will need to be updated when we assign proper ownership
...
CREATE OR REPLACE VIEW crm_migration_summary AS
SELECT 
