...
export function useDeals() {
  ...
  // Fetch stages from Supabase (still using Supabase for stages)
  ...
  const fetchDeals = useCallback(async () => {
    try {
      ...
      // Fetch both deals (from Neon) and stages (from Supabase) in parallel
      ...
      console.log('✅ Supabase stages:', stagesData.length);
