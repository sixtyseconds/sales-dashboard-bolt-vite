            ...
            <div className="space-y-3">
              {[1, 2, 3].map(i => (
                <div key={i} className="h-24 bg-gray-700/50 rounded-lg animate-pulse">
                  <div className="h-4 bg-gray-600 rounded mt-4 mx-4 w-3/4"></div>
                  <div className="h-3 bg-gray-600 rounded mt-2 mx-4 w-1/2"></div>
                  <div className="h-3 bg-gray-600 rounded mt-2 mx-4 w-1/4"></div>
                </div>
              ))}
            </div>
          ) : tasks.length > 0 ? (
