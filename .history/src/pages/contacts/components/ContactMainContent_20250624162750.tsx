        ...
        <div className="section-card">
          ...
          {loading ? (
            <div className="space-y-3">
              {[1, 2, 3].map(i => (
                <div key={i} className="h-20 bg-gray-700/30 rounded-lg animate-pulse border border-gray-600/20">
                  <div className="p-4 space-y-2">
                    <div className="h-4 bg-gray-600/50 rounded w-3/4"></div>
                    <div className="h-3 bg-gray-600/40 rounded w-1/2"></div>
                    <div className="flex justify-between items-center">
                      <div className="h-3 bg-gray-600/40 rounded w-1/4"></div>
                      <div className="h-6 bg-gray-600/40 rounded w-16"></div>
                    </div>
                  </div>
                </div>
              ))}
