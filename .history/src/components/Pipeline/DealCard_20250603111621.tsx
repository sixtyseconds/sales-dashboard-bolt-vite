...
export function DealCard({ deal, onClick, isDragOverlay = false }: DealCardProps) {
  ...
  // DEBUG: Log the deal object to see what data we're getting
  console.log('🔍 DealCard Debug - Deal object:', {
    id: deal.id,
    name: deal.name || deal.company,
    companies: deal.companies,
    contacts: deal.contacts,
    deal_contacts: deal.deal_contacts,
    hasCompanyId: !!deal.company_id,
    hasPrimaryContactId: !!deal.primary_contact_id,
    companyField: deal.company,
    contactField: deal.contact_name
  });
  ...
  const stageName = useMemo(() => {
    console.log('Deal stages in DealCard:', deal.id, companyInfo.name, deal.deal_stages, 'Stage ID:', deal.stage_id);
  ...
  }, [deal.deal_stages, deal.id, companyInfo.name, deal.stage_id]);
