...
const TaskForm: React.FC<TaskFormProps> = ({
  ...
  const handleDealChange = (dealId: string) => {
    ...
    setFormData(prev => ({
      ...prev,
      deal_id: dealId,
      // Auto-populate contact info from deal
      contact_email: selectedDeal?.contact_email || prev.contact_email,
      contact_name: selectedDeal?.contact_name || prev.contact_name,
      company: selectedDeal?.company || prev.company,
      // Try to link to structured data if available
      company_id: selectedDeal?.company_id || prev.company_id,
      contact_id: selectedDeal?.primary_contact_id || prev.contact_id
    }));
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.deal_id} onValueChange={handleDealChange}>
                <SelectTrigger className="bg-gray-800/50 border-gray-700">
