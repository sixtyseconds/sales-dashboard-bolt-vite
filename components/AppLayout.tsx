      ...
      <div className="fixed top-0 left-0 right-0 flex items-center justify-between z-50 p-4 bg-gray-950/50 backdrop-blur-sm border-b border-gray-800/50 lg:hidden">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-white/90">{userData?.name}</span>
                  ...
                  {menuItems.map((item) => (
                    ...
                    >
                      <item.icon className={cn(
                        "w-5 h-5",
                        pathname === item.href ? 'text-white' : 'text-gray-400/80'
                      )} />
      ...
      >
        ...
        <div className={cn(
          ...
          <div className="flex flex-col gap-2">
            ...
            <button className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-red-400 hover:bg-red-500/10 transition-colors">
